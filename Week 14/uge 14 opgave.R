...
# because the “i_dan” item already have a “setview” code and “addProviderTiles” code in it.
...
# Code and text written by (Lasse)
# The libraries “library(tidyverse)”, “library(googlesheets4)”, and “library(leaflet)” are activated 
# to make the integration of google sheets data available and usable in our DANmap.
...
# Text written by (Benjamin & Lasse)
...
# If you have i large dataset the clustering of areas can help the map, nop to be cluttered. Therefore it is easier to understand.  
...
# Lasse: https://github.com/Digital-Methods-HASS/Au753705_Lasse_Walmar/tree/main/Week%2014 

# Simon: https://github.com/Digital-Methods-HASS/690090_Pedersen_Simon/tree/main/Week%2014 

# Benjamin: 
# https://github.com/Digital-Methods-HASS/202108995_Rosenstr-m_Benjamin/tree/main/Week%2014 
